...
OhdsiRTools::checkUsagePackage("RehospitalizationPredictionWithNote")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/RehospitalizationPredictionWithNote.pdf")
shell("R CMD Rd2pdf ./ --output=extras/RehospitalizationPredictionWithNote.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("RehospitalizationPredictionWithNote")
